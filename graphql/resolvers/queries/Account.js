...
exports.default = {
    Query: {
        ...
        verifyTokenNewAccount: (_, { token }) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                const { code, email } = jsonwebtoken_1.default.verify(token, `${process.env.TOKEN_VERIFY_ACCOUNT}`);
                const accountFound = yield database_1.Account.findOne({
